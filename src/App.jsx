...
//               </label>
//               <div>
//                 <select className='w-full' ref={fromRef}>
...
//               </label>
//               <div>
//                 <select className='w-full' ref={toRef}>
//                   {Object.entries(currencies).map(([code, { name }]) => (
//                     <option key={code} value={(code, name)}>
//                       {code}
//                       {' - '}
...
function App() {
  ...
  const toRef = useRef();
  const [value, setValue] = useState('1.00');
  const [fromCurrency, setFromCurrency] = useState('USD'); // Default value
  const [toCurrency, setToCurrency] = useState('EUR'); // Default value
